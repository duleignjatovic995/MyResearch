function vectorImage = imageTo20x20Gray(fileName, cropPercentage)
%IMAGETO20X20GRAY display reduced image and converts for digit classification
%
% Sample usage: 
%       imageTo20x20Gray('myDigit.jpg', 100);
%
...
scale = [28 28] ./ finalSize; % Brojeve menjati u zavisnosti od pixela
